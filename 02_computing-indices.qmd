...
We provide examples of many of these in the main text and supporting information of the main text of our paper. Further, these can be generated as derived quantities within a Bayesian model or using posterior samples of the above quantities ($N$, $z$, or $\psi$) in R.
